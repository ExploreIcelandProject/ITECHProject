...
def run_query(search_terms, size=10):
    ...
    webhose_api_key = '9e1763fe-de6c-44f4-8a62-a15b11abc17a'
...
# What's the base URL for the Webhose API?
    ...
    # Python dictionary.
        ...
        # Loop through the posts, appending each to the results list as # a dictionary. We restrict the summary to the first 200
        # characters, as summary responses from Webhose can be long! for post in json_response['posts']:
